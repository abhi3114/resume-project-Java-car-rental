...
<html>
   ...
   <body style="background-image: url('${pageContext.request.contextPath}/background/3.jpg');background-size:cover; background-repeat: no-repeat;">
       <h3><a href="index_1.html" style="margin-left:20px;">Go to Homepage</a></h3>
   <center><br>       
        <table width="30%"  >   
            <tr>
           ...
           <tr>
                <td>            
                    <form name="loginForm" class="form-horizontal" action="CustomerLogin" method="post"><br>
             <div>
                <div class="form-group">
                    <label id="wtext">Email:</label>                     
                    <input type="text" placeholder="Enter Email address here" maxlength="30" class="form-control" name="username" required>
                </div>  
                <div class="  form-group">
                    <label id="wtext">Password:</label>
               ...
               &nbsp;&nbsp;    
               Click<a href="customer-registration.jsp"><span class="link"><strong> register</strong></span></a> to open an admin account
